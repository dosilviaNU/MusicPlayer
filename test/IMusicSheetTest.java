...
public abstract class IMusicSheetTest {
  ...
  public static final class MidiCompositionTest extends IMusicSheetTest {
    ...
    public void testTempo() {
      ...
      comp1.setTempo(1);
      assertEquals(comp1.getTempo(), 1);
      comp1.setTempo(1000000000);
    ...
    public void testGetInstrumentChannelHigh() {
      initData();
      IComposition comp1 = new MidiComposition();
      comp1.getInstrument(16);
    }

    @Test
    //Tests get Tempo
    public void testGetInstrumentChannel() {
      initData();
      IComposition comp1 = new MidiComposition();
      for (int i = 0; i < 16; i++) {
        assertEquals(comp1.getInstrument(i), 0);
        comp1.setInstrument(i, i);
        assertEquals(comp1.getInstrument(i), i);
      }
  ...
  public static final class ROMidiCompositionTest extends IMusicSheetTest {
    public IMusicSheet makeSheet() {
